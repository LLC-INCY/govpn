...
// errNoNATT rejects a peer that never advertised NAT-T. govpn's ESP data path
...
var errNoNATT = errors.New("ikev1: peer does not support NAT-T (RFC 3947), which govpn requires for UDP-encapsulated ESP")
...
//
// govpn always claims to be behind a NAT: it sends a random hash for its own
